...
public class oneMorning {
    ...
    public oneMorning(Stage primaryStage) {
        ...
        continueButton = new Button("Transition to 2 AM");
        ...
        buttonBox.getChildren().addAll(oneButton, twoButton, threeButton, fourButton, fiveButton, sixButton, continueButton);
